# Generated by Powerlevel10k configuration wizard on 2024-10-09 at 10:25 IDT.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%6F'     # default foreground
      local      clean='%6F'    # white foreground
      local   modified='%5F'    # cyan foreground
      local  untracked='%11F'   # yellow foreground
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_VISUAL_IDENTIFIER_COLOR=15
  # Custom icon.
